...
## Project Structure
    ...
    ├── proud_butterfly_29172  # Django project configurations
...
1. Clone this repo and `cd proud_butterfly_29172`
...
2. Clone this repo and `cd proud_butterfly_29172`
